...
namespace ManageATenancyAPI.Tests.Actions
{
    public class ETRAMeetingsActionTest
    {
        ...
        public async Task successful_etra_meeting_should_return_etra_object()
        {
            ...
            ETRAMeetingsAction tmiActions = new ETRAMeetingsAction(mockILoggerAdapter.Object, mocktmiCallBuilder.Object, mockingApiCall.Object, mockAccessToken.Object, mockConfig.Object, mockDateService.Object);
