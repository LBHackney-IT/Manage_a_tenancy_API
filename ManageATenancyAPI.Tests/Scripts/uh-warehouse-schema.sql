...
/****** Object:  Table [dbo].[property]    Script Date: 10/12/2018 01:31:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[property](
	...
	[practical_completion] [smalldatetime] NULL,
	[handover] [smalldatetime] NULL,
	[cat_type] [char](3) NULL,
	[lounge] [bit] NOT NULL,
	[laundry] [bit] NOT NULL,
	[visitor_bed] [bit] NOT NULL,
	[store] [bit] NOT NULL,
	[warden_flat] [bit] NOT NULL,
	...
	[core_shared] [bit] NOT NULL,
	[rep_officer] [char](3) NULL,
	[ins_value] [int] NULL,
	[u_nom2] [char](10) NULL,
	[region] [char](3) NULL,
	[asbestos] [bit] NOT NULL,
	...
	[child_allowed] [bit] NULL,
	[local_conn] [bit] NULL,
	[alloc_panel] [bit] NULL,
	[num_steps] [int] NULL,
	[garage] [bit] NULL,
	[maxage_restric] [int] NULL,
	[stair_lift] [bit] NULL,
	[through_lift] [bit] NULL,
	[acc_shower] [bit] NULL,
	[ramp] [bit] NULL,
	[hand_rails] [bit] NULL,
	[dining_room] [bit] NULL,
	[kitchen_dining] [bit] NULL,
	[sec_toileta] [bit] NULL,
	...
	[online_repairs] [bit] NOT NULL,
	[vm_propref] [char](16) NULL,
	[voidman_live] [bit] NULL,
	[repairable] [bit] NOT NULL,
	...
	[u_gas_service_req] [bit] NULL,
	[u_int_decent] [char](3) NULL,
	[u_lever_taps] [char](3) NULL,
	[u_lift_manufact] [char](3) NULL,
	[u_rtb_start] [datetime] NULL,
	[u_sold_leased] [char](3) NULL,
	[u_sold_leased_date] [datetime] NULL,
	[u_disabled_only] [bit] NULL,
	[u_date_disposed_due] [datetime] NULL,
	[u_leased_from] [char](3) NULL,
	[u_lease_end_date] [datetime] NULL,
	[u_estate_management] [char](3) NULL,
	[u_access_floor] [char](3) NULL,
	[u_lift_available] [bit] NULL,
	[u_block_floors] [char](3) NULL,
	[u_balcony] [bit] NULL,
	[u_door_entry] [bit] NULL,
	[u_council_property] [bit] NULL,
	[u_oap_only] [bit] NULL,
	[u_disabled_occupier] [bit] NULL,
	...
	[u_raised_sockets] [bit] NULL,
	[u_ramped_access] [bit] NULL,
	[u_stair_lift] [bit] NULL,
	[u_wchair_std] [char](3) NULL,
	[u_kitchenunit] [bit] NULL,
	...
	[epc_cert_date] [smalldatetime] NULL,
	[epc_surv_date] [smalldatetime] NULL,
	[epc_rq_date] [smalldatetime] NULL,
	[epc_rec_date] [smalldatetime] NULL,
	[epc_energy] [numeric](3, 0) NULL,
	[epc_co2] [numeric](3, 0) NULL,
	[sc_sinkfund] [numeric](8, 2) NULL,
	[u_s20_factor] [numeric](8, 4) NULL,
	[u_buy_back_date] [smalldatetime] NULL,
	[u_shared_bathroom] [bit] NULL,
	[u_shared_toilet] [bit] NULL,
	[u_temp_tenure] [char](3) NULL,
	[u_disrepair] [bit] NULL,
	[u_lha_area] [char](3) NULL,
	[u_est_man] [char](50) NULL,
	[u_cleaner] [char](50) NULL,
	[u_ahr_cat] [char](3) NULL,
	[u_shared_kitchen] [bit] NULL,
	[u_rsl_prop_ref] [char](16) NULL,
	[u_uses_com_boiler] [bit] NULL,
	[u_uses_door_ent] [bit] NULL,
	[u_uses_lift] [bit] NULL,
	[u_mw_patch] [char](3) NULL,
	[u_year_built] [char](4) NULL,
	[u_hand_back_date] [smalldatetime] NULL,
